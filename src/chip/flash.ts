...
import { READ_FLASH_DATA_CHIP_SETTINGS_SUB_COMMAND, READ_FLASH_DATA_FACTORY_SERIAL_NUMBER_SUB_COMMAND, READ_FLASH_DATA_GP_SETTINGS_SUB_COMMAND, READ_FLASH_USB_MANUFACTURER_SUB_COMMAND_CODE, READ_FLASH_USB_PRODUCT_SUB_COMMAND_CODE, READ_FLASH_USB_SERIAL_NUMBER_SUB_COMMAND_CODE, WRITE_FLASH_DATA_CHIP_SETTINGS_SUB_COMMAND, WRITE_FLASH_DATA_GP_SETTINGS_SUB_COMMAND, WRITE_FLASH_DATA_MANUFACTURER_SUB_COMMAND, WRITE_FLASH_DATA_PRODUCT_SUB_COMMAND, WRITE_FLASH_DATA_SERIAL_NUMBER_SUB_COMMAND } from '../messages/message.consts.js'
